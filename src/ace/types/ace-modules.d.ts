...
declare module "ace/anchor" {
	...
	export class Anchor {
		...
		constructor(
			doc: Document,
			row: number | import("ace").Ace.Point,
			column?: number,
		);
		/**
...
declare module "ace/config" {
	const _exports: {
		 ...
		 */
		get: <K extends keyof import("ace").Ace.ConfigOptions>(
			key: K,
		) => import("ace").Ace.ConfigOptions[K];
		set: <K extends keyof import("ace").Ace.ConfigOptions>(
			key: K,
			value: import("ace").Ace.ConfigOptions[K],
		) => void;
...
declare module "ace/layer/marker" {
	...
	export class Marker {
		...
		setSession(session: EditSession): void;
		session: import("ace/edit_session").EditSession;
		setMarkers(markers: { [x: number]: import("ace").Ace.MarkerLike }): void;
		markers: {
...
declare module "ace/virtual_renderer" {
	...
	export class VirtualRenderer {
		...
		pixelToScreenCoordinates(
			x: number,
			y: number,
		): import("ace").Ace.ScreenCoordinates;
...
declare module "ace/commands/command_manager" {
	...
	export class CommandManager extends MultiHashHandler {
		...
		exec(
			command: string | string[] | import("ace").Ace.Command,
			editor: Editor,
			args: any,
		): boolean;
		canExecute(
			command: string | import("ace").Ace.Command,
			editor: Editor,
		): boolean;
...
declare module "ace/editor" {
	...
	export class Editor {
		...
		constructor(
			...
			session?: EditSession,
			options?: Partial<import("ace").Ace.EditorOptions>,
		);
		session: EditSession;
		container: HTMLElement & {
			env?: any;
		 ...
		 **/
		setKeyboardHandler(
			keyboardHandler: string | import("ace").Ace.KeyboardHandler | null,
			cb?: () => void,
		): void;
		/**
		...
		completer?:
			| import("ace").Ace.Autocomplete
			| import("ace").Ace.InlineAutocomplete;
	...
	namespace Ace {
		type EditorMultiSelectProperties =
			import("ace").Ace.EditorMultiSelectProperties;
		type OptionsProvider<T> = import("ace").Ace.OptionsProvider<T>;
		...
		type ElasticTabstopsEditorExtension =
			import("ace").Ace.ElasticTabstopsEditorExtension;
...
declare module "ace/autocomplete/inline" {
	...
	export class AceInline {
		...
		show(
			editor: Editor,
			completion: import("ace").Ace.Completion,
			prefix: string,
		): boolean;
...
declare module "ace/autocomplete" {
	...
	export class CompletionProvider {
		...
		gatherCompletions(
			editor: Editor,
			callback: import("ace").Ace.CompletionCallbackFunction,
		): boolean;
		completers: import("ace").Ace.Completer[];
		/**
	...
	export type CompletionProviderOptions =
		import("ace").Ace.CompletionProviderOptions;
...
declare module "ace/search_highlight" {
	...
	export class SearchHighlight {
		...
		update(
			...
			markerLayer: Marker,
			session: EditSession,
			config: Partial<import("ace").Ace.LayerConfig>,
		): void;
		MAX_RANGES: number;
	}
}
...
declare module "ace/marker_group" {
	...
	export class MarkerGroup {
		...
		getMarkerAtPosition(
			pos: import("ace").Ace.Point,
		): import("ace").Ace.MarkerGroupItem | undefined;
		/**
...
declare module "ace/background_tokenizer" {
	...
	namespace Ace {
		...
		type BackgroundTokenizerEvents =
			import("ace").Ace.BackgroundTokenizerEvents;
	}
...
declare module "ace/edit_session/folding" {
	...
	export class Folding {
		 ...
		 **/
		getFoldsInRange: (
			range: import("ace").Ace.Range | import("ace").Ace.Delta,
		) => import("ace").Ace.Fold[];
		getFoldsInRangeList: (
			ranges: import("ace").Ace.Range[] | import("ace").Ace.Range,
		) => import("ace").Ace.Fold[];
		/**
		...
		getFoldStringAt: (
			...
			column: number,
			trim?: number,
			foldLine?: import("ace").Ace.FoldLine,
		) => string | null;
		getFoldLine: (
			docRow: number,
			startFoldLine?: import("ace").Ace.FoldLine,
		) => null | import("ace").Ace.FoldLine;
		/**
		 ...
		 */
		addFold: (
			placeholder: import("ace").Ace.Fold | string,
		...
		unfold: (
			location?:
				| number
				| null
				| import("ace").Ace.Point
				| import("ace").Ace.Range
				| import("ace").Ace.Range[],
			expandInner?: boolean,
		) => import("ace").Ace.Fold[] | undefined;
		/**
		...
		isRowFolded: (
			docRow: number,
			startFoldRow?: import("ace").Ace.FoldLine,
		) => boolean;
		getRowFoldEnd: (
			docRow: number,
			startFoldRow?: import("ace").Ace.FoldLine,
		...
		getCommentFoldRange: (
			...
			column: number,
			dir?: number,
		) => import("ace").Ace.Range | undefined;
		foldAll: (
			startRow?: number | null,
			endRow?: number | null,
			depth?: number | null,
...
declare module "ace/edit_session" {
	...
	export class EditSession {
		 ...
		 **/
		addDynamicMarker(
			marker: import("ace").Ace.MarkerLike,
			inFront?: boolean,
		): import("ace").Ace.MarkerLike;
		/**
