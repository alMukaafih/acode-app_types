...
declare module "ace/layer/font_metrics" {
    ...
    namespace Ace {
        ...
        }> = import("ace").Ace.EventEmitter<T>;
        type FontMetricsEvents = import("ace").Ace.FontMetricsEvents;
    }
    export interface FontMetrics extends Ace.EventEmitter<Ace.FontMetricsEvents> {
    }
}
declare module "ace/apply_delta" {
    export function applyDelta(docLines: string[], delta: import("ace").Ace.Delta, doNotValidate?: any): void;
}
declare module "ace/document" {
    ...
    export type Delta = import("ace").Ace.Delta;
    export type Point = import("ace").Ace.Point;
    export type IRange = import("ace").Ace.IRange;
    export type NewLineMode = import("ace").Ace.NewLineMode;
    ...
    namespace Ace {
        ...
        type DocumentEvents = import("ace").Ace.DocumentEvents;
    }
...
declare module "ace/anchor" {
    ...
    export class Anchor {
         ...
         **/
        constructor(doc: Document, row: number | import("ace").Ace.Point, column?: number);
        /**
         * Returns an object identifying the `row` and `column` position of the current anchor.
         **/
        getPosition(): import("ace").Ace.Point;
        /**
         *
    ...
    namespace Ace {
        ...
        type AnchorEvents = import("ace").Ace.AnchorEvents;
        type Document = import("ace").Ace.Document;
    }
...
declare module "ace/config" {
    const _exports: {
         ...
         * @returns {import("ace").Ace.ConfigOptions[K]} - The value of the config option.
         */
        get: <K extends keyof import("ace").Ace.ConfigOptions>(key: K) => import("ace").Ace.ConfigOptions[K];
        set: <K extends keyof import("ace").Ace.ConfigOptions>(key: K, value: import("ace").Ace.ConfigOptions[K]) => void;
        all: () => import("ace").Ace.ConfigOptions;
        /**
         * module loading
         */
...
declare module "ace/layer/lines" {
    ...
    export type LayerConfig = import("ace").Ace.LayerConfig;
    export class Lines {
...
declare module "ace/layer/gutter" {
    export class Gutter {
        ...
        config: import("ace").Ace.LayerConfig;
        oldLastRow: number;
    ...
    export type EditSession = import("ace/edit_session").EditSession;
    export type LayerConfig = import("ace").Ace.LayerConfig;
    import { Lines } from "ace/layer/lines";
    namespace Ace {
        type EventEmitter<T extends {
            [K in keyof T]: (...args: any[]) => any;
        }> = import("ace").Ace.EventEmitter<T>;
        type GutterEvents = import("ace").Ace.GutterEvents;
    }
...
declare module "ace/layer/marker" {
    ...
    export class Marker {
        ...
        session: import("ace/edit_session").EditSession;
        setMarkers(markers: {
            [x: number]: import("ace").Ace.MarkerLike;
        }): void;
        markers: {
            [x: number]: import("ace").Ace.MarkerLike;
        };
...
declare module "ace/layer/text" {
    ...
    namespace Ace {
        ...
        type TextEvents = import("ace").Ace.TextEvents;
        type LayerConfig = import("ace").Ace.LayerConfig;
    }
...
declare module "ace/layer/cursor" {
    export class Cursor {
        ...
        getPixelPosition(position?: import("ace").Ace.Point, onScreen?: boolean): {
            left: number;
            top: number;
        };
...
declare module "ace/scrollbar" {
    ...
    namespace Ace {
        ...
        type ScrollbarEvents = import("ace").Ace.ScrollbarEvents;
    }
...
declare module "ace/virtual_renderer" {
    ...
    export class VirtualRenderer {
        ...
        scrollBarV: import("ace").Ace.VScrollbar;
        scrollBarH: import("ace").Ace.HScrollbar;
        scrollTop: number;
        scrollLeft: number;
        cursorPos: {
            row: number;
         ...
         *
         **/
        setAnnotations(annotations: import("ace").Ace.Annotation[]): void;
        /**
         *
        ...
        pixelToScreenCoordinates(x: number, y: number): import("ace").Ace.ScreenCoordinates;
    ...
    export type EditSession = import("ace/edit_session").EditSession;
    export type Point = import("ace").Ace.Point;
    export type Theme = import("ace").Ace.Theme;
    import { Gutter as GutterLayer } from "ace/layer/gutter";
    import { Marker as MarkerLayer } from "ace/layer/marker";
    import { Text as TextLayer } from "ace/layer/text";
    import { Cursor as CursorLayer } from "ace/layer/cursor";
    import { VScrollBar } from "ace/scrollbar";
    import { FontMetrics } from "ace/layer/font_metrics";
    import { RenderLoop } from "ace/renderloop";
    import { Decorator } from "ace/layer/decorators";
    namespace Ace {
        type EventEmitter<T extends {
            [K in keyof T]: (...args: any[]) => any;
        }> = import("ace").Ace.EventEmitter<T>;
        type VirtualRendererEvents = import("ace").Ace.VirtualRendererEvents;
        type OptionsProvider<T> = import("ace").Ace.OptionsProvider<T>;
        type VirtualRendererOptions = import("ace").Ace.VirtualRendererOptions;
        type EditSession = import("ace").Ace.EditSession;
    }
...
declare module "ace/selection" {
    export class Selection {
         ...
         **/
        setRange(range: import("ace").Ace.IRange, reverse?: boolean): void;
        /**
        ...
        **/
        ...
        setSelectionRange: (range: import("ace").Ace.IRange, reverse?: boolean) => void;
    }
    export type EditSession = import("ace/edit_session").EditSession;
    ...
    namespace Ace {
        ...
        type MultiSelectionEvents = import("ace").Ace.MultiSelectionEvents;
        type MultiSelectProperties = import("ace").Ace.MultiSelectProperties;
    }
...
declare module "ace/mouse/default_handlers" {
    ...
    export class DefaultHandlers {
        ...
        onMouseDown(this: import("ace/mouse/mouse_handler").MouseHandler, ev: MouseEvent): void;
        mousedownEvent: import("ace/mouse/mouse_event").MouseEvent;
        startSelect(this: import("ace/mouse/mouse_handler").MouseHandler, pos?: import("ace").Ace.Position, waitForClickSelection?: boolean): void;
        select(this: import("ace/mouse/mouse_handler").MouseHandler): void;
        extendSelectionBy(this: import("ace/mouse/mouse_handler").MouseHandler, unitName: string | number): void;
        selectByLinesEnd(this: import("ace/mouse/mouse_handler").MouseHandler): void;
        focusWait(this: import("ace/mouse/mouse_handler").MouseHandler): void;
        onDoubleClick(this: import("ace/mouse/mouse_handler").MouseHandler, ev: MouseEvent): void;
        onTripleClick(this: import("ace/mouse/mouse_handler").MouseHandler, ev: MouseEvent): void;
        onQuadClick(this: import("ace/mouse/mouse_handler").MouseHandler, ev: MouseEvent): void;
        onMouseWheel(this: import("ace/mouse/mouse_handler").MouseHandler, ev: MouseEvent): void;
        selectEnd: (this: import("ace/mouse/mouse_handler").MouseHandler) => void;
        selectAllEnd: (this: import("ace/mouse/mouse_handler").MouseHandler) => void;
        selectByWordsEnd: (this: import("ace/mouse/mouse_handler").MouseHandler) => void;
    }
}
declare module "ace/tooltip" {
    ...
    export class Tooltip {
        ...
        setTheme(theme: import("ace").Ace.Theme): void;
...
declare module "ace/mouse/default_gutter_handler" {
    export function GutterHandler(this: import("ace/mouse/mouse_handler").MouseHandler, mouseHandler: MouseHandler): void;
...
declare module "ace/mouse/dragdrop_handler" {
    ...
    export class DragdropHandler {
        constructor(mouseHandler: MouseHandler);
        onDragStart: (this: import("ace/mouse/mouse_handler").MouseHandler, e: any) => any;
        onDragEnd: (this: import("ace/mouse/mouse_handler").MouseHandler, e: any) => any;
        onDragEnter: (this: import("ace/mouse/mouse_handler").MouseHandler, e: any) => any;
        onDragOver: (this: import("ace/mouse/mouse_handler").MouseHandler, e: any) => any;
        onDragLeave: (e: any) => void;
        onDrop: (this: import("ace/mouse/mouse_handler").MouseHandler, e: any) => any;
    }
}
...
declare module "ace/mouse/mouse_handler" {
    export class MouseHandler {
        ...
        destroy(): void;
        cancelDrag?: boolean;
        mousedownEvent?: import("ace").Ace.MouseEvent;
        startSelect?: (pos?: import("ace").Ace.Point, waitForClickSelection?: boolean) => void;
        select?: () => void;
        selectEnd?: () => void;
    }
    export type Editor = import("ace/editor").Editor;
    ...
    namespace Ace {
        type Range = import("ace").Ace.Range;
        type MouseEvent = import("ace").Ace.MouseEvent;
        type Point = import("ace").Ace.Point;
    }
...
declare module "ace/keyboard/keybinding" {
    export type Editor = import("ace/editor").Editor;
    export type KeyboardHandler = import("ace").Ace.KeyboardHandler;
...
declare module "ace/search" {
    export type EditSession = import("ace/edit_session").EditSession;
    export type SearchOptions = import("ace").Ace.SearchOptions;
    /**
...
declare module "ace/keyboard/hash_handler" {
    export type Command = import("ace").Ace.Command;
    export type CommandLike = import("ace").Ace.CommandLike;
...
declare module "ace/commands/command_manager" {
    ...
    export class CommandManager extends MultiHashHandler {
         ...
         **/
        constructor(platform: import("ace/keyboard/hash_handler").Platform, commands: any[]);
        byName: Record<string, import("ace").Ace.Command>;
        exec(command: string | string[] | import("ace").Ace.Command, editor: Editor, args: any): boolean;
        canExecute(command: string | import("ace").Ace.Command, editor: Editor): boolean;
    ...
    namespace Ace {
        ...
        type CommandManagerEvents = import("ace").Ace.CommandManagerEvents;
    }
...
declare module "ace/commands/default_commands" {
    export const commands: import("ace").Ace.Command[];
}
declare module "ace/token_iterator" {
    ...
    export class TokenIterator {
         ...
         **/
        stepBackward(): import("ace").Ace.Token | null;
        /**
         * Moves iterator position to the start of next token.
         **/
        stepForward(): import("ace").Ace.Token | null;
        /**
         *
         * Returns current token.
         **/
        getCurrentToken(): import("ace").Ace.Token;
        /**
         *
         ...
         */
        getCurrentTokenPosition(): import("ace").Ace.Point;
        /**
...
declare module "ace/editor" {
    ...
    export class Editor {
         ...
         * @param {Partial<import("ace").Ace.EditorOptions>} [options] The default options
         **/
        constructor(renderer: VirtualRenderer, session?: EditSession, options?: Partial<import("ace").Ace.EditorOptions>);
        session: EditSession;
        container: HTMLElement & {
            env?: any;
            value?: any;
         ...
         **/
        setKeyboardHandler(keyboardHandler: string | import("ace").Ace.KeyboardHandler | null, cb?: () => void): void;
        /**
         ...
         **/
        setTheme(theme: string | import("ace").Ace.Theme, cb?: () => void): void;
        /**
         ...
         **/
        getSelectionStyle(): import("ace").Ace.EditorOptions["selectionStyle"];
        /**
        ...
        env?: any;
        widgetManager?: import("ace").Ace.LineWidgets;
        completer?: import("ace").Ace.Autocomplete | import("ace").Ace.InlineAutocomplete;
        completers: import("ace").Ace.Completer[];
        showKeyboardShortcuts?: () => void;
        showSettingsMenu?: () => void;
        searchBox?: import("ace").Ace.SearchBox;
    }
    ...
    import { CommandManager } from "ace/commands/command_manager";
    import { MouseHandler } from "ace/mouse/mouse_handler";
    import { KeyBinding } from "ace/keyboard/keybinding";
    import { Search } from "ace/search";
    import { Range } from "ace/range";
    var $uid: number;
    namespace Ace {
        type EditorMultiSelectProperties = import("ace").Ace.EditorMultiSelectProperties;
        type OptionsProvider<T> = import("ace").Ace.OptionsProvider<T>;
        type EditorOptions = import("ace").Ace.EditorOptions;
        type EventEmitter<T extends {
            [K in keyof T]: (...args: any[]) => any;
        }> = import("ace").Ace.EventEmitter<T>;
        type EditorEvents = import("ace").Ace.EditorEvents;
        type CodeLenseEditorExtension = import("ace").Ace.CodeLenseEditorExtension;
        type ElasticTabstopsEditorExtension = import("ace").Ace.ElasticTabstopsEditorExtension;
        type TextareaEditorExtension = import("ace").Ace.TextareaEditorExtension;
        type PromptEditorExtension = import("ace").Ace.PromptEditorExtension;
        type OptionsEditorExtension = import("ace").Ace.OptionsEditorExtension;
        type EditSession = import("ace").Ace.EditSession;
        type LineWidgets = import("ace").Ace.LineWidgets;
        type Autocomplete = import("ace").Ace.Autocomplete;
        type InlineAutocomplete = import("ace").Ace.InlineAutocomplete;
        type Completer = import("ace").Ace.Completer;
        type SearchBox = import("ace").Ace.SearchBox;
    }
...
declare module "ace/undomanager" {
    ...
    export class UndoManager {
         ...
         *
         **/
        add(delta: import("ace").Ace.Delta, allowMerge: boolean, session?: EditSession): void;
        lastDeltas: any[];
        ...
        getRevision(): number;
        getDeltas(from: number, to?: number): import("ace").Ace.Delta[];
...
declare module "ace/autocomplete/popup" {
    ...
    export class AcePopup {
        ...
        isTopdown: boolean;
        autoSelect: boolean;
        data: import("ace").Ace.Completion[];
        setData: (data: import("ace").Ace.Completion[], filterText?: string) => void;
        getData: (row: number) => import("ace").Ace.Completion;
        hide: () => void;
        anchor: "top" | "bottom";
        anchorPosition: import("ace").Ace.Point;
        ...
        goTo: (where: import("ace").Ace.AcePopupNavigation) => void;
    ...
    namespace Ace {
        type AcePopupWithEditor = import("ace").Ace.AcePopupWithEditor;
        type Completion = import("ace").Ace.Completion;
        type Point = import("ace").Ace.Point;
        type AcePopupNavigation = import("ace").Ace.AcePopupNavigation;
    }
...
declare module "ace/range_list" {
    ...
    export class RangeList {
        ...
        onChange: any;
        detach(): void;
        comparePoints: (p1: import("ace/range").Point, p2: import("ace/range").Point) => number;
    }
    import { Range } from "ace/range";
}
declare module "ace/snippets" {
    ...
    class SnippetManager {
        ...
        createTokenizer(): any;
        tokenizeTmSnippet(str: any, startState: any): (string | import("ace").Ace.Token)[];
...
declare module "ace/autocomplete/inline" {
    ...
    export class AceInline {
         ...
         */
        show(editor: Editor, completion: import("ace").Ace.Completion, prefix: string): boolean;
...
declare module "ace/autocomplete" {
    ...
    export class CompletionProvider {
        ...
        gatherCompletions(editor: Editor, callback: import("ace").Ace.CompletionCallbackFunction): boolean;
        completers: import("ace").Ace.Completer[];
        /**
        ...
        detach(): void;
        completions: import("ace").Ace.FilteredList;
    }
    export type Editor = import("ace/editor").Editor;
    export type CompletionProviderOptions = import("ace").Ace.CompletionProviderOptions;
    export type CompletionOptions = import("ace").Ace.CompletionOptions;
    export type Position = import("ace").Ace.Position;
    export type BaseCompletion = {
         ...
         */
        value?: string;
        completer?: import("ace").Ace.Completer;
    ...
    namespace Ace {
        type AcePopup = import("ace").Ace.AcePopup;
        type FilteredList = import("ace").Ace.FilteredList;
    }
...
declare module "ace/line_widgets" {
    export class LineWidgets {
        constructor(session: EditSession);
        session: import("ace/edit_session").EditSession;
        updateOnChange(delta: import("ace").Ace.Delta): void;
        ...
        firstRow: number;
        lastRow: number;
        lineWidgets: import("ace").Ace.LineWidget[];
    }
    export type EditSession = import("ace/edit_session").EditSession;
    export type Editor = import("ace/editor").Editor;
    export type VirtualRenderer = import("ace/virtual_renderer").VirtualRenderer;
    export type LineWidget = import("ace").Ace.LineWidget;
    namespace Ace {
        type LineWidget = import("ace").Ace.LineWidget;
        type Editor = import("ace").Ace.Editor;
    }
...
declare module "ace/search_highlight" {
    ...
    export class SearchHighlight {
        ...
        regExp: any;
        cache: any[];
        update(html: any, markerLayer: Marker, session: EditSession, config: Partial<import("ace").Ace.LayerConfig>): void;
        MAX_RANGES: number;
    }
}
...
declare module "ace/marker_group" {
    ...
    export class MarkerGroup {
        ...
        markers: import("ace").Ace.MarkerGroupItem[];
        session: EditSession;
        /**
         * Finds the first marker containing pos
         */
        getMarkerAtPosition(pos: import("ace").Ace.Point): import("ace").Ace.MarkerGroupItem | undefined;
        /**
...
declare module "ace/edit_session/fold" {
    export class Fold extends RangeList {
        ...
        placeholder: any;
        range: import("ace/range").Range;
        start: import("ace").Ace.Point;
        end: import("ace").Ace.Point;
        sameRow: boolean;
        subFolds: Fold[];
...
declare module "ace/edit_session/fold_line" {
    ...
    export class FoldLine {
        ...
        toString(): string;
        idxToPosition(idx: number): import("ace").Ace.Point;
    }
    import { Range } from "ace/range";
}
...
declare module "ace/background_tokenizer" {
    ...
    export class BackgroundTokenizer {
         ...
         **/
        getTokens(row: number): import("ace").Ace.Token[];
        /**
    ...
    namespace Ace {
        ...
        type BackgroundTokenizerEvents = import("ace").Ace.BackgroundTokenizerEvents;
    }
...
declare module "ace/edit_session/folding" {
    export type IFolding = import("ace/edit_session").EditSession & import("ace").Ace.Folding;
    export type Delta = import("ace").Ace.Delta;
    ...
    export class Folding {
         ...
         **/
        getFoldAt: (row: number, column: number, side?: number) => import("ace").Ace.Fold;
        /**
         * Returns all folds in the given range. Note, that this will return folds
         **/
        getFoldsInRange: (range: import("ace").Ace.Range | import("ace").Ace.Delta) => import("ace").Ace.Fold[];
        getFoldsInRangeList: (ranges: import("ace").Ace.Range[] | import("ace").Ace.Range) => import("ace").Ace.Fold[];
        /**
         * Returns all folds in the document
         */
        getAllFolds: () => import("ace").Ace.Fold[];
        /**
         ...
         */
        getFoldStringAt: (row: number, column: number, trim?: number, foldLine?: import("ace").Ace.FoldLine) => string | null;
        getFoldLine: (docRow: number, startFoldLine?: import("ace").Ace.FoldLine) => null | import("ace").Ace.FoldLine;
        /**
         * Returns the fold which starts after or contains docRow
         */
        getNextFoldLine: (docRow: number, startFoldLine?: import("ace").Ace.FoldLine) => null | import("ace").Ace.FoldLine;
         ...
         */
        addFold: (placeholder: import("ace").Ace.Fold | string, range?: import("ace").Ace.Range) => import("ace").Ace.Fold;
        addFolds: (folds: import("ace").Ace.Fold[]) => void;
        removeFold: (fold: import("ace").Ace.Fold) => void;
        removeFolds: (folds: import("ace").Ace.Fold[]) => void;
        expandFold: (fold: import("ace").Ace.Fold) => void;
        expandFolds: (folds: import("ace").Ace.Fold[]) => void;
        unfold: (location?: number | null | import("ace").Ace.Point | import("ace").Ace.Range | import("ace").Ace.Range[], expandInner?: boolean) => import("ace").Ace.Fold[] | undefined;
        /**
         * Checks if a given documentRow is folded. This is true if there are some
         * folded parts such that some parts of the line is still visible.
         **/
        isRowFolded: (docRow: number, startFoldRow?: import("ace").Ace.FoldLine) => boolean;
        getRowFoldEnd: (docRow: number, startFoldRow?: import("ace").Ace.FoldLine) => number;
        getRowFoldStart: (docRow: number, startFoldRow?: import("ace").Ace.FoldLine) => number;
        getFoldDisplayLine: (foldLine: import("ace").Ace.FoldLine, endRow?: number | null, endColumn?: number | null, startRow?: number | null, startColumn?: number | null) => string;
        ...
        getCommentFoldRange: (row: number, column: number, dir?: number) => import("ace").Ace.Range | undefined;
        ...
        getParentFoldRangeData: (row: number, ignoreCurrent?: boolean) => {
            range?: import("ace").Ace.Range;
            firstRange?: import("ace").Ace.Range;
        };
        onFoldWidgetClick: (row: number, e: any) => void;
        toggleFoldWidget: (toggleParent?: boolean) => void;
        updateFoldWidgets: (delta: import("ace").Ace.Delta) => void;
...
declare module "ace/edit_session/bracket_match" {
    ...
    export class BracketMatch {
        findMatchingBracket: (this: import("ace/edit_session").EditSession, position: Point, chr?: string) => import("ace").Ace.Point;
        getBracketRange: (this: import("ace/edit_session").EditSession, pos: Point) => null | Range;
        /**
         * Returns:
         ...
         *
         */
        getMatchingBracketRanges: (this: import("ace/edit_session").EditSession, pos: Point, isBackwards?: boolean) => null | Range[];
        /**
         * Returns [[Range]]'s for matching tags and tag names, if there are any
         */
        getMatchingTags: (this: import("ace/edit_session").EditSession, pos: Point) => {
            closeTag: Range;
            closeTagName: Range;
            openTag: Range;
            openTagName: Range;
...
declare module "ace/edit_session" {
    ...
    export class EditSession {
        ...
        */
        ...
        selection: Selection;
        destroyed: boolean;
        curOp: import("ace").Ace.Operation | null;
        /**
         ...
         *
         **/
        getTokenAt(row: number, column: number): import("ace").Ace.Token;
        /**
         ...
         **/
        addMarker(range: Range, clazz: string, type?: import("ace").Ace.MarkerRenderer | "fullLine" | "screenLine" | "text" | "line", inFront?: boolean): number;
        /**
         ...
         **/
        addDynamicMarker(marker: import("ace").Ace.MarkerLike, inFront?: boolean): import("ace").Ace.MarkerLike;
        /**
        ...
        getMarkers(inFront?: boolean): {
            [id: number]: import("ace").Ace.MarkerLike;
        };
         ...
         **/
        getAnnotations(): import("ace").Ace.Annotation[];
        /**
         ...
         **/
        setNewLineMode(newLineMode: import("ace").Ace.NewLineMode): void;
        /**
         *
         * Returns the current new line mode.
         * @related Document.getNewLineMode
         **/
        getNewLineMode(): import("ace").Ace.NewLineMode;
        /**
         ...
         **/
        getValue: () => string;
        lineWidgets: null | import("ace").Ace.LineWidget[];
    ...
    export type Delta = import("ace").Ace.Delta;
    export type IRange = import("ace").Ace.IRange;
    export type SyntaxMode = import("ace").Ace.SyntaxMode;
    export type LineWidget = import("ace").Ace.LineWidget;
    ...
    import { BidiHandler } from "ace/bidihandler";
    import { Range } from "ace/range";
    import { LineWidgets } from "ace/line_widgets";
    ...
    namespace Ace {
        ...
        type EditSessionEvents = import("ace").Ace.EditSessionEvents;
        type OptionsProvider<T> = import("ace").Ace.OptionsProvider<T>;
        type EditSessionOptions = import("ace").Ace.EditSessionOptions;
        type Folding = import("ace").Ace.Folding;
        type BracketMatch = import("ace").Ace.BracketMatch;
        type Document = import("ace").Ace.Document;
        type Point = import("ace").Ace.Point;
        type Occur = import("ace").Ace.Occur;
        type Operation = import("ace").Ace.Operation;
    }
...
declare module "ace/placeholder" {
    export class PlaceHolder {
        constructor(session: EditSession, length: number, pos: import("ace").Ace.Point, others: any[], mainClass: string, othersClass: string);
        length: number;
        session: import("ace/edit_session").EditSession;
        doc: import("ace/document").Document;
        mainClass: string;
        ...
        updateAnchors(delta: import("ace").Ace.Delta): void;
        updateMarkers(): void;
        /**
         * PlaceHolder.detach()
         *
    ...
    namespace Ace {
        ...
        type PlaceHolderEvents = import("ace").Ace.PlaceHolderEvents;
    }
...
declare module "ace/commands/multi_select_commands" {
    export const defaultCommands: import("ace").Ace.Command[];
    export const multiSelectCommands: import("ace").Ace.Command[];
...
declare module "ace/multi_select" {
    ...
    export type Anchor = import("ace/anchor").Anchor;
    export type Point = import("ace").Ace.Point;
    export type ScreenCoordinates = import("ace").Ace.ScreenCoordinates;
...
declare module "ace/split" {
    export type ISplit = import("ace").Ace.EventEmitter<any> & {
        [key: string]: any;
    };
