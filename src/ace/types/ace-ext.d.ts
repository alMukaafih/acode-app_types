...
declare module "ace/ext/command_bar" {
	...
	export class CommandBarTooltip {
		constructor(
			...
			options?: Partial<import("ace").Ace.CommandBarOptions>,
		);
		parentNode: HTMLElement;
		tooltip: Tooltip;
		moreOptions: Tooltip;
...
declare module "ace/ext/code_lens" {
	export function setLenses(
		session: EditSession,
		lenses: import("ace").Ace.CodeLense[],
	): number;
	export function registerCodeLensProvider(
		editor: import("ace/editor").Editor,
		codeLensProvider: import("ace").Ace.CodeLenseProvider,
	): void;
...
declare module "ace/ext/hardwrap" {
	export function hardWrap(
		editor: import("ace/editor").Editor,
		options: import("ace").Ace.HardWrapOptions,
	): void;
	import { Editor } from "ace/editor";
}
...
declare module "ace/ext/static_highlight" {
	function highlight(
		el: HTMLElement,
		opts: import("ace").Ace.StaticHighlightOptions,
		callback?: any,
	): boolean;
