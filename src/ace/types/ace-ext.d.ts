...
declare module "ace/ext/command_bar" {
    ...
    export class CommandBarTooltip {
        constructor(parentNode: HTMLElement, options?: Partial<import("ace").Ace.CommandBarOptions>);
    ...
    export type TooltipCommand = import("ace").Ace.TooltipCommand;
    ...
    namespace Ace {
        ...
        type CommandBarEvents = import("ace").Ace.CommandBarEvents;
    }
...
declare module "ace/ext/language_tools" {
    ...
    export var keyWordCompleter: import("ace").Ace.Completer;
    export var snippetCompleter: import("ace").Ace.Completer;
...
declare module "ace/ext/inline_autocomplete" {
    ...
    export class InlineAutocomplete {
         ...
         */
        show(options: import("ace").Ace.CompletionOptions): void;
        activated: boolean;
        insertMatch(): boolean;
        goTo(where: import("ace").Ace.InlineAutocompleteAction): void;
        getLength(): any;
        getData(index?: number): import("ace").Ace.Completion | undefined;
        getIndex(): number;
        isOpen(): boolean;
        setIndex(value: number): void;
        getCompletionProvider(initialPosition: any): CompletionProvider;
        completionProvider: CompletionProvider;
        updateCompletions(options?: import("ace").Ace.CompletionOptions): void;
        ...
        commands: {
            [key: string]: import("ace").Ace.Command;
        };
    }
...
declare module "ace/ext/error_marker" {
    export function showErrorMarker(editor: import("ace/editor").Editor, dir: number): void;
}
declare module "ace/ext/beautify" {
    ...
    export function beautify(session: import("ace/edit_session").EditSession): void;
...
declare module "ace/ext/code_lens" {
    export function setLenses(session: EditSession, lenses: import("ace").Ace.CodeLense[]): number;
    export function registerCodeLensProvider(editor: import("ace/editor").Editor, codeLensProvider: import("ace").Ace.CodeLenseProvider): void;
...
declare module "ace/ext/hardwrap" {
    export function hardWrap(editor: import("ace/editor").Editor, options: import("ace").Ace.HardWrapOptions): void;
    import { Editor } from "ace/editor";
}
...
declare module "ace/ext/menu_tools/get_editor_keyboard_shortcuts" {
    export function getEditorKeybordShortcuts(editor: import("ace/editor").Editor): any[];
}
...
declare module "ace/ext/options" {
    ...
    namespace Ace {
        ...
        type OptionPanelEvents = import("ace").Ace.OptionPanelEvents;
    }
...
declare module "ace/ext/simple_tokenizer" {
     ...
     */
    export function tokenize(content: string, highlightRules: import("ace").Ace.HighlightRules): import("ace").Ace.TokenizeResult;
}
...
declare module "ace/ext/static_highlight" {
    function highlight(el: HTMLElement, opts: import("ace").Ace.StaticHighlightOptions, callback?: any): boolean;
    ...
    type SyntaxMode = import("ace").Ace.SyntaxMode;
    type Theme = import("ace").Ace.Theme;
}
