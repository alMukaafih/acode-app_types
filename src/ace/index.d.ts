...
declare module "ace" {
	export namespace Ace {
		...
		type InlineAutocomplete =
			import("ace/ext/inline_autocomplete").InlineAutocomplete;
		...
		type GutterHandler =
			import("ace/mouse/default_gutter_handler").GutterHandler;
		...
		type GutterTooltip =
			import("ace/mouse/default_gutter_handler").GutterTooltip;
		type GutterKeyboardEvent =
			import("ace/keyboard/gutter_handler").GutterKeyboardEvent;
		...
		export type CommandBarTooltip =
			import("ace/ext/command_bar").CommandBarTooltip;
		export type TokenizeResult = Array<
			Array<{
				className?: string;
				value: string;
			}>
	...
	export const config: typeof import("ace/config");
	...
	export function createEditSession(
		text: import("ace/document").Document | string,
		mode?: import("ace").Ace.SyntaxMode,
	): EditSession;
	import { Editor } from "ace/editor";
	import { EditSession } from "ace/edit_session";
	import { Range } from "ace/range";
	import { UndoManager } from "ace/undomanager";
	import { VirtualRenderer as Renderer } from "ace/virtual_renderer";
	...
	export {
		...
		EditSession,
		UndoManager,
		Renderer as VirtualRenderer,
	};

	export var require: Require;
	export var define: RequireDefine;
}
