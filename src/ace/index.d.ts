...
declare module "ace" {
    export namespace Ace {
        ...
        type KeyboardHandler = Partial<import("ace/keyboard/hash_handler").HashHandler> & {
        ...
        type CompletionProviderCallback = (this: import("ace/autocomplete").Autocomplete, err: Error | undefined, completions: import("ace/autocomplete").FilteredList, finished: boolean) => void;
        ...
        export type CommandBarTooltip = import("ace/ext/command_bar").CommandBarTooltip;
    ...
    export function createEditSession(text: import("ace/document").Document | string, mode?: import("ace").Ace.SyntaxMode): EditSession;
